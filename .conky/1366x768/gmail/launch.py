...
# unread_prefix = '${font Hack Nerd Font Mono:pixelsize=20}${color ' + args.color + '}' + args.prefix + '${font}${color} '
# error_prefix = '${font Hack Nerd Font Mono:pixelsize=20}${color ' + args.color + '}\uf06a${font}${color} '
