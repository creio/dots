...
pactl load-module module-loopback source=alsa_input.pci-0000_00_1b.0.analog-stereo sink=mic_raw_in channels=1 source_dont_move=true sink_dont_move=true
elif [[ $1 == "-u" ]]; then
