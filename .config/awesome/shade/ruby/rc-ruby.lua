...
taglist.names = {
	...
	"Spare", "Back", "Test", "Vbox", "Data", "Free"
}
...
redflat.float.player:init({ name = ncmpcpp })
...
if redflat.startup.is_startup then
	local autostart = require("shade.ruby.autostart-config") -- load file with autostart application list
	autostart.run()
end