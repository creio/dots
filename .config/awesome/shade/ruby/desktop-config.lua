...
function desktop:init(args)
	...
	disks.args = {
		sensors  = {
			...
			{ meter_function = system.fs_info, maxm = 100, crit = 80, name = "files",   args = "/media/files" },
	...
	thermal_storage.args = {
		sensors = {
			...
			{ async_function = ssd_smart_check, maxm = 80, crit = 70, name = "hdd" },
	...
	local desktop_objects = {
		calendar, cpumem, disks, netspeed
	}
