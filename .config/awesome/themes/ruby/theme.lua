...
theme.color.main   = "#5a74ca"
theme.color.urgent = "#A30817"
...
theme.desktopbg    = theme.path .. "/wall/wl3.jpg"
...
theme.desktop.grid = {
	...
	edge   = { width = { 40, 650 }, height = { 100, 100 } }
}
...
theme.desktop.speedmeter.compact.label.font = { font = "Play", size = 12, face = 1, slant = 0 }
...
--------------------------------------------------------------------------------
theme.float.hotkeys.geometry   = { width = 1300 }
theme.float.hotkeys.heights    = { key = 20, title = 18 }
theme.float.hotkeys.border_margin = { 10, 10, 10, 0 }
