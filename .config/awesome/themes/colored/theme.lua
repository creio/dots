...
------------------------------------------------------------
theme.fonts = {
	main     = "Clear Sans Medium 9",      -- main font
	menu     = "Roboto bold 10",      -- main menu font
	tooltip  = "Clear Sans Medium 9",      -- tooltip font
	notify   = "Play bold 11",   -- redflat notify popup font
	clock    = "Play bold 10",   -- textclock widget font
	qlaunch  = "Play bold 11",   -- quick launch key label font
	keychain = "Play bold 13",   -- key sequence tip font
	title    = "Roboto bold 10", -- widget titles font
	tiny     = "Clear Sans Medium 9", -- smallest font for widgets
	titlebar = "Roboto bold 10", -- client titlebar font
	hotkeys  = {
		main  = "Roboto bold 10",             -- hotkeys helper main font
		key   = "Roboto bold 11", -- hotkeys helper key font (use monospace for align)
...
function theme:update()
	...
	self.service.navigator.keytip["grid"]    = { geometry = { width = 1300 }, column = 2, exit = true }
	self.service.navigator.keytip["usermap"] = { geometry = { width = 1300 }, column = 2, exit = true }
	...
	-- Hotkeys helper
	------------------------------------------------------------
	self.float.hotkeys.geometry = { width = 1350 }
